...
module Command
  class Result < BasicObject
    ...
    # @api private
    #
    # @see Command::Result#respond_to_missing?
  ...
  module Interface
    ...
    #
    # @return [Command::Result] the result of the operation
    #
  ...
  #
  # @param [Command::Result, ApplicationRecord] source
  # @param [String] header
